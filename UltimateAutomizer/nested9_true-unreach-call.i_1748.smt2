...
(assert
 ...
 (let (($x117 (exists ((v_nnf_96_st IntState) (val!70 Int) )(let ((?x56 (val2 v_nnf_96_st)))
 (let (($x35 (<= ?x56 4)))
 (let (($x136 (and (<= (+ ?x56 2) c_main_~k~6) (<= c_main_~j~6 (+ (* 2 ?x56) 2)) $x35)))
 (let (($x52 (not (= v_nnf_96_st (Mk1 val!70)))))
 (and $x52 $x136))))))
 ))
 ...
 (and (and $x120 $x111 $x143 $x148 $x98) (not (and $x120 $x111 $x117 $x98)))))))))))
(check-sat)
